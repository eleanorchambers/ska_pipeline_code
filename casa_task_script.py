...
'''Instructions: input variables to CASA, ie results_txt = 'xxx', weighting = 'xxx'. 
		Put fits files names to be used into txt file called fits_filenames.txt
...
def main():
    ...
    myuv_fits = _fits_file_list_('../fits_filenames.txt') #must be string also, hopefully designed to be a list that is iterated over
